...
saving_output_path = str(Path.home()) + "/law_fieldlab/testing/zero_shot_prompting/filtered_mmr_responses.csv"
...
#    context = ""
    ...
    for idx, input_text in enumerate(questions):
        ...
        context_data = get_data(input_text, 4, questions_df, idx, "mmr")
